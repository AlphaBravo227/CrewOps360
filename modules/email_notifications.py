    ...
    def create_needs_swap_decision_content(self, staff_name, track_name, decision, details=None):
        ...
        Args:
            ...
            details (dict, optional): need_day, need_period, give_up_day, give_up_period,
                expected_base, relaxations (list of str), superseded (int), reviewed_by
        ...
        if approved:
            ...
            expected_base = details.get('expected_base')
            if expected_base:
                change_lines.append(
                    f"- Expected base for the new shift: {expected_base} "
                    "(assigned by the usual seniority draft, same as any other shift)"
                )
...
def send_needs_swap_decision_notification(staff_name, staff_email, track_name, decision, details=None):
    ...
    Args:
        ...
        decision (str): 'approved' or 'declined'
        details (dict, optional): need_day, need_period, give_up_day, give_up_period,
            expected_base, relaxations, superseded, reviewed_by
