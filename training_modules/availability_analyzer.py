...
class AvailabilityAnalyzer:
    ...
    def _get_excel_enrollment_roles(self):
        """
        Get {staff_name: role} for the roster.

        Reads the staff database when it has been imported, falling back to the
        workbook's Role column otherwise.
        """
        staff_roles = {}

        try:
            from modules.staff_database import get_base_role_mapping, staff_count
