...
def main():
    ...
    print("       Deleting a folder is the one command that differs by shell:")
    print("")
    print("         PowerShell:  Remove-Item -Recurse -Force venv")
    print("         cmd.exe:     rmdir /s /q venv")
    print("         macOS:       rm -rf venv")
    print("")
    print("       then:")
    print("")
    print("         Windows:  py -%s -m venv venv" % PREFERRED)
    print("                   venv\\Scripts\\activate")
    print("         macOS:    python%s -m venv venv" % PREFERRED)
